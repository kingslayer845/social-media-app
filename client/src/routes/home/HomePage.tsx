...
export default function HomePage() {
  return (
    <section className="max-w-sm mx-auto space-y-5 py-5 md:max-w-lg lg:max-w-5xl lg:grid lg:grid-cols-7 lg:gap-5 lg:space-y-0 lg:py-10 xl:max-w-7xl xl:grid-cols-10">
